...
Pod::Spec.new do |s|
  ...
  s.homepage       = "https://github.com/rich111/react-native-vlcplayer-wrap2"
  s.license        = "MIT"
  s.author         = { "Rich111 Chen" => "rich111.chen@gmail.com" }
  s.platforms      = { :ios => "9.0", :tvos => "9.2" }
  s.source         = { :git => "https://github.com/rich111/react-native-vlcplayer-wrap2.git", :tag => "v#{s.version}" }
